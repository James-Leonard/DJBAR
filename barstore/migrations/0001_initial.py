    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cost_per_item', models.DecimalField(decimal_places=2, max_digits=19, null=True)),
                ('sales', models.DecimalField(blank=True, decimal_places=2, max_digits=19, null=True)),
                ('quantity_damaged', models.IntegerField(blank=True, default='0', null=True)),
                ...
                ('category', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, to='barstore.category')),
            ],
        ),
        migrations.CreateModel(
            name='Stock',
